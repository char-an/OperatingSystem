...
void thread_s1(struct image_t *input_image)
{
    // cout << "S1" << endl;
...
void thread_s2(struct image_t *input_image)
{
...
void thread_s3(struct image_t *input_image)
{
...
int main(int argc, char **argv)
{
    ...
    for (int i = 0; i < SIZE; i++)
    {
        ...
        thread t1(thread_s1, input_image);
        thread t2(thread_s2, input_image);
        thread t3(thread_s3, input_image);
